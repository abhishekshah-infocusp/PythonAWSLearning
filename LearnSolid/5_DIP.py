...
class NotARobot(Authorizer):
    ...
    def not_a_robot_check(self):
        print("Performing not a robot check...")
        # Simulate a check that always passes
        return True

    def is_authorized(self) -> bool:
        print("Not a robot check passed.")
        return True
...
authorizer2 = NotARobot()
processor2 = PaypalPaymentProcessor("3456", authorizer2)
